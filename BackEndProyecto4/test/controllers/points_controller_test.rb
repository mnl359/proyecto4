...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { lat: @point.lat, lng: @point.lng, route_id: @point.route_id } }, as: :json
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { lat: @point.lat, lng: @point.lng, route_id: @point.route_id } }, as: :json
    assert_response 200
  end
